_base_ = [r'C:\Users\Daniel\Documents\Masters\S2\OR\Fashion_Segmentation\mmsegmentation\configs\swin\swin-tiny-patch4-window7-in1k-pre_upernet_8xb2-160k_ade20k-512x512.py']
...
crop_size = (192, 192)
num_classes = 47
work_dir = r'C:\Users\Daniel\Documents\Masters\S2\OR\Fashion_Segmentation\mmseg_workdirs\stage1_lr__full__upernet_swin-tiny__192x192__lr0p0003__auto__basic__ranking_short'

train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations', reduce_zero_label=False),
    dict(type='RandomResize', scale=(192, 192), ratio_range=(0.8, 1.2), keep_ratio=False),
    dict(type='RandomFlip', prob=0.5),
    dict(type='RandomRotate', prob=0.3, degree=10, pad_val=0, seg_pad_val=255),
    dict(type='RandomCrop', crop_size=(192, 192), cat_max_ratio=0.9),
...
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations', reduce_zero_label=False),
    dict(type='Resize', scale=(192, 192), keep_ratio=False),
    dict(type='PackSegInputs'),
]
...
optim_wrapper = dict(optimizer=dict(lr=0.0003))
